...
$quizSql = "SELECT * FROM quiz WHERE isSolved = 0 ORDER BY quizId DESC";
    ...
    <div id="wrap">
        ...
        <div id="main">
            <div id="aside">
                ...
                <?php include "quizFilter.php" ?>

                </ul>
                <ul class="aside__nav">
                    <li>
                        <a href="../quiz/quizCreate.php">    
                    ...
                    <li>
                        <a href="../quiz/quizMatchstick.php">      
            ...
            <div id="container">
                <div class="container-nav">
                    <h3>뇌섹 남녀</h3>
                    <div class="list">
                        <h3>각 문제에 좋아요 표시를 하세요!<br>찜 목록에서 확인할 수 있습니다.</h3>
                        <p>창의력, 추리, 수학, 성냥개비 다양한 문제가 있습니다. 도전해보세요!</p>
                    </div>
                </div>
